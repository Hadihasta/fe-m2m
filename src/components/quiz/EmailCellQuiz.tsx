...
const CASES: Row[] = [
  {
    ...
    recipients: ['very-long-email-address-for-testing-truncation@example-company-domain.com'],
  },
  {
    id: 'C2',
  ...
  },
  {
    ...
    recipients: ['a@test.com', 'b@test.com', 'c@test.com', 'd@test.com', 'e@test.com'],
  },
  {
    id: 'C4',
    subject: 'One super long + one short',
    recipients: ['someone-really-really-long-address@sub.domain.example.com', 'x@x.io'],
  },
  {
    id: 'C5',
    subject: 'Edge: empty',
  ...
  },
  {
    ...
    recipients: ['user+tag@domain.com', 'name.surname@company.co.uk', 'weird_email@sub.domain.io'],
  },
  {
    id: 'C10',
    ...
    <div className="quiz-wrap">
      ...
      <div className="quiz-panel">
        <div className="quiz-controls">
          ...
          />
          <div className="quiz-note">Move the slider to simulate narrow vs wide cell space.</div>
        </div>

        <div
          className="quiz-table-wrap"
          ref={tableWrapRef}
        >
          <table className="tbl quiz-table">
            <thead>
              <tr>
                ...
                <th>Subject</th>
                <th style={{ width: recipientsColWidthPx }}>Recipients (Email)</th>
              </tr>
            </thead>
            <tbody>
              {CASES.map((r) => (
                <tr key={r.id}>
                  ...
                  <td>
                    ...
                    <EmailCell
                      emails={r.recipients}
                      currentWidth={recipientsColWidthPx}
                    />
                  </td>
                </tr>
              ))}
          ...
          <p className="hint">
            Goal: the cell’s behavior must follow the rules listed in the challenge checklist below.
          </p>
        </div>
      </div>
